...
def main( ):
    ...
    from analysis.pipeline import results_pipeline, redshift_ab_pipeline
    ...
    rmp = redshift_ab_pipeline( namestring, ns_of_interest=div_pipe.get_results( ) )
    rmp.plot_results( BASE_PLOT_PATH, "test-rmp.pdf" )
